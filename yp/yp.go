...
func DisplayInstructions() {
	text := "Your instance can be listed on the Owncast directory at http://directory.owncast.online by enabling YP in your config.  " +
	  "Learn more at https://directory.owncast.online/get-listed."
